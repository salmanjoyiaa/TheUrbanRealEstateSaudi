...
function AgentSignupPage() {
  ...
  const initialAgentType: "property" | "visiting" | "seller" | "maintenance" =
    typeParam === "visiting" || typeParam === "property" || typeParam === "seller" || typeParam === "maintenance" ? typeParam : "property";
