...
export async function POST(request: Request) {
  ...
  const payload: Database["public"]["Tables"]["properties"]["Insert"] = {
    ...
    two_entrance: parsed.data.two_entrance ?? undefined,
    ...
    building_condition: parsed.data.building_condition || undefined,
    ...
    facebook_video_url: parsed.data.facebook_video_url || null,
    instagram_video_url: parsed.data.instagram_video_url || null,
    youtube_video_url: parsed.data.youtube_video_url || null,
    tiktok_video_url: parsed.data.tiktok_video_url || null,
    agent_id: agentId,
    status: "pending",
    featured: false,
  };
