...
export function SiteFooter({ variant = "default" }: SiteFooterProps) {
  ...
  if (isHomepage) {
    return (
      <footer className="gradient-primary border-t border-white/10 py-10 sm:py-12">
        <div className="container mx-auto max-w-[1400px] px-4 sm:px-5 lg:px-12">
          <div className="mb-8 grid grid-cols-1 gap-8 md:mb-10 md:grid-cols-2 lg:grid-cols-4 md:gap-10">
            <div>
              <span className="mb-2 block text-xl font-black tracking-tight text-white">
  ...
  return (
    <footer className="border-t border-border bg-card py-12 text-card-foreground">
      <div className="mx-auto flex w-full max-w-[1400px] flex-col items-center gap-6 px-4 sm:px-5 lg:px-12">
