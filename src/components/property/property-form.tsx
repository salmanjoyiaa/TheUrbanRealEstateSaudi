  ...
  const submit = async () => {
    ...
    try {
      const payload = {
        ...
        water_bill_included: initialData?.water_bill_included || "",
        security_deposit: securityDeposit || "",
        nearby_places: nearbyPlaces,
        drive_link: driveLink || "",
        building_condition: buildingCondition || "",
        broker_fee: brokerFee || "",
        payment_methods_accepted: paymentMethodsAccepted || "",
        cover_image_index: coverImageIndex,
        installments: installments || "",
        blocked_dates: initialData?.blocked_dates || [],
        visiting_agent_instructions: visitingAgentInstructions || "",
        visiting_agent_image: visitingAgentImage[0] || "",
